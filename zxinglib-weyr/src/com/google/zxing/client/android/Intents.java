...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * the results.
     */
    public static final String ACTION = "weyr.SCAN";
  ...
  public static final class Encode {
    ...
    /**
     * The aux data to encode. Use {@link android.content.Intent#putExtra(String, String)} or
     * {@link android.content.Intent#putExtra(String, android.os.Bundle)}, 
     * depending on the type and format specified.
     */    
    public static final String DATA1 = "ENCODE_DATA1";
    
    /**
     * The sheep name to encode. Use {@link android.content.Intent#putExtra(String, String)} or
     * {@link android.content.Intent#putExtra(String, android.os.Bundle)}, 
     * depending on the type and format specified.
     */
    public static final String SHEEPNAME = "ENCODE_SHEEPNAME";

    /**
     * Encode autoprint. 
     */
    public static final String AUTOPRINT = "ENCODE_AUTOPRINT";
     ...
     * depending on the type and format specified.
     */  
    public static final String DATE = "ENCODE_DATE";  
