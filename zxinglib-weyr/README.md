Although not recommended by the zxing developers, this code has been
modified from the zxing library code. This is due to the enterprise
nature of the LambTracker project. The specific mods are necessary
to cuistomize the barcode image generation so it works with both
the LambTracker application and the LambTracker Print Utility.
There is lots of code left over from the zxing library which may
be removed in ther future.

The rest of this file is from the zxing library.
